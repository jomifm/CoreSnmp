...
SnmpXmlMapper::SnmpXmlMapper(QObject *parent)
    : QObject(parent)
{
    LogFuncionBegin;
    LogFuncionEnd;
...
SnmpXmlMapper::~SnmpXmlMapper()
{
    LogFuncionBegin;
    LogFuncionEnd;
}

QDomDocument SnmpXmlMapper::getDomDocument(const QString & strFile)
{
...
void SnmpXmlMapper::parsingCfg (const QString & strFile)
{
	LogFuncionBegin;
...
void SnmpXmlMapper::mappingMib (const QString & strFile)
{
	QString strTag;
	QString strProperty, strValue;
	QString strName, strResource;
...
QString SnmpXmlMapper::searchOids(QString strParent)
{
...
void SnmpXmlMapper::appendObjectData(const QString & strTab, const QString & strName,
