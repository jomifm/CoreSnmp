...
public:
	...
	static QString getSnmpCommunity() { return snmpCommunity_; }
	static void setSnmpCommunity(const QString & strCommunity) {
		snmpCommunity_ = strCommunity;
	}
